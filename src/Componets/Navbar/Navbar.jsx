...
function Navbar() {
  ...
  const toggleInternships = () => {
    const newState = !isDivVisibleForintern;
    setDivVisibleForintern(newState);
    document.getElementById('ico').className = newState ? 'bi bi-caret-up-fill' : 'bi bi-caret-down-fill';
  };

  const toggleJobs = () => {
    const newState = !isDivVisibleForJob;
    setDivVisibleFroJob(newState);
    document.getElementById('ico2').className = newState ? 'bi bi-caret-up-fill' : 'bi bi-caret-down-fill';
  };
    ...
    <div>
      <nav className='nav1'>
        <ul>
          ...
          <div className='elem'>
            <Link to={'/Internship'}>
              <p id='int' className='' onClick={toggleInternships}>
                {' '}
                Internships <i id='ico' className='bi bi-caret-down-fill'></i>
              </p>
            </Link>
            <Link to={'/Jobs'}>
              <p onClick={toggleJobs}>
